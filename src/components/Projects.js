        ...
        <Box className='projects' sx={{ paddingTop: 5 }}>
            ...
            <Grid container columns={1} >
                <Fade left>
                    ...
                    <Grid item xs={4}>
                        <Box sx={{ width: "36vw", pl:"18vw"}}>
                            ...
                            <Typography variant="body1" sx={{ textAlign: "justify", mt: 1, fontFamily: "Cardo, serif", fontSize:"2vh" }} gutterBottom>
                ...
                <Fade right>
                    <Grid item xs={4}>
                        <Box sx={{mt: "75px", ml: "5vw", mb: 0, width: "29vw", mr: "25vw" }}>
                            ...
                            <Divider sx={{ background: "rgb(27, 99, 61)", width: "50vh" }} />
                            <Typography variant="body1" sx={{ fontFamily: "Cardo, serif", textAlign: "justify", mt: 1, width: "36vw", fontSize:"2vh" }} gutterBottom>
                ...
                <Fade left>
                    ...
                    <Grid item xs={4}>
                        <Box sx={{marginLeft: "19vw", pt: "9vh", width: "29vw"}}>
                            ...
                            <Typography variant="body1" sx={{ textAlign: "justify", fontFamily: "Cardo, serif", mt: 1, width: "35vw", fontSize: "2vh" }} gutterBottom>
